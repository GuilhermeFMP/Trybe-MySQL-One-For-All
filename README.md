...
Terceiro projeto de Back End fornecido pela instituição Trybe, onde utilizamos queries para manipular informações, junção de tabelas no banco de dados e Normalização de tabelas.


## Aprendizados

Aprendi nesse projeto a utilizar o MySql ralizando queries e manipulando informações e unindo tabelas, além de Normalização de tabelas.
